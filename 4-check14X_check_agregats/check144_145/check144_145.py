...
with open(input_filename) as csvfile:
    ...
    for row in tableau:
        if (i == 0):
            ...
            output_x_alignements.write("\t".join(row) + "\t" + "\t".join(["ARK 141","Titres 141","ARK 144","Titres 144","ARK 145","Titres 145","ARK 744","Titres 744","ARK 745","Titres 745"]) + "\n")
        else:
...
for oeuvre,val in liste_oeuvres.items():
    ...
    if (len(liste141)+len(liste144)+len(liste145)+len(liste744)+len(liste745) == 0):
        ...
        for manif in val:
            ...
            liens_manif = liste_dedup(manifid)
            output_1_alignement.write(manifval + "\t" + field + "\t" + liens_manif + "\t" + titreOeuvre + "\n")
    else:
        ...
        for manif in val:
            manif = manif.split("~")
            output_x_alignements.write(manif[1] 
