...
def one_file(input_filename):
    ...
    # 3e étape : dedupe pour regrouper des clusters qui partage les mêmes ARK
    # En entrée : le nom du fichier "clusters sans agregats sans lien aux oeuvres"
    # produit à l'étape précédente
    dedupe_records.dedupe1file(liste_reports[0].name, 0)
