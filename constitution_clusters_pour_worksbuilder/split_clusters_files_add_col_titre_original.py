...
def import_file():
    ...
    split_value = input("Combien de clusters par fichier [défaut : 1000] ?\n")
    if (split_value == ""):
        split_value = 1000
    else:
        split_value = int(split_value)
    id_traitement = input("identifiant du traitement (facultatif) : ")
